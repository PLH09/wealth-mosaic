...
export const STRINGS = {
  en: {
    ...
    fbMenu: "Send feedback",
    fbTitle: "Send feedback",
    fbIntro: "Your thoughts help make Wealth Mosaic better. Tell us what's working or what's not.",
    fbTypes: { bug: "Bug report", idea: "Suggestion", other: "Other" },
    fbPlaceholder: "Describe the issue or idea…",
    fbSend: "Open email to send",
    fbCancel: "Cancel",
    fbEmpty: "Please write something before sending.",
    fbNote: "“Open email to send” opens your mail app with the message pre-filled — nothing is sent automatically, and no financial data is attached.",
    fbSubject: (type) => `[Wealth Mosaic] ${type}`,
  ...
  "zh-TW": {
    ...
    fbMenu: "意見回饋",
    fbTitle: "意見回饋",
    fbIntro: "你的想法會幫助 Wealth Mosaic 變得更好。告訴我們哪裡順手、哪裡卡關。",
    fbTypes: { bug: "問題回報", idea: "功能建議", other: "其他" },
    fbPlaceholder: "描述你遇到的狀況或想法…",
    fbSend: "開啟郵件送出",
    fbCancel: "取消",
    fbEmpty: "請先寫點內容再送出。",
    fbNote: "按「開啟郵件送出」會開啟你的郵件 App、內容已幫你填好——不會自動送出,也不會附上任何財務數字。",
    fbSubject: (type) => `[Wealth Mosaic] ${type}`,
  ...
  "zh-CN": {
    ...
    fbMenu: "意见回馈",
    fbTitle: "意见回馈",
    fbIntro: "你的想法会帮助 Wealth Mosaic 变得更好。告诉我们哪里顺手、哪里卡关。",
    fbTypes: { bug: "问题回报", idea: "功能建议", other: "其他" },
    fbPlaceholder: "描述你遇到的状况或想法…",
    fbSend: "开启邮件送出",
    fbCancel: "取消",
    fbEmpty: "请先写点内容再送出。",
    fbNote: "按「开启邮件送出」会开启你的邮件 App、内容已帮你填好——不会自动送出,也不会附上任何财务数字。",
    fbSubject: (type) => `[Wealth Mosaic] ${type}`,
  ...
  ja: {
    ...
    fbMenu: "フィードバック",
    fbTitle: "フィードバック",
    fbIntro: "あなたの声が Wealth Mosaic をより良くします。良い点も気になる点もお聞かせください。",
    fbTypes: { bug: "不具合の報告", idea: "機能の提案", other: "その他" },
    fbPlaceholder: "状況やアイデアを書いてください…",
    fbSend: "メールを開いて送信",
    fbCancel: "キャンセル",
    fbEmpty: "送信する前に内容を入力してください。",
    fbNote: "「メールを開いて送信」を押すとメールアプリが開き、本文が入力済みになります。自動送信はされず、財務データも添付されません。",
    fbSubject: (type) => `[Wealth Mosaic] ${type}`,
  ...
  ko: {
    ...
    fbMenu: "피드백 보내기",
    fbTitle: "피드백 보내기",
    fbIntro: "여러분의 의견이 Wealth Mosaic을 더 좋게 만듭니다. 좋은 점도 불편한 점도 알려 주세요.",
    fbTypes: { bug: "버그 신고", idea: "기능 제안", other: "기타" },
    fbPlaceholder: "겪은 상황이나 아이디어를 적어 주세요…",
    fbSend: "메일 열어 보내기",
    fbCancel: "취소",
    fbEmpty: "보내기 전에 내용을 입력해 주세요.",
    fbNote: "「메일 열어 보내기」를 누르면 메일 앱이 열리고 내용이 미리 입력됩니다. 자동 전송되지 않으며, 금융 데이터는 첨부되지 않습니다.",
    fbSubject: (type) => `[Wealth Mosaic] ${type}`,
