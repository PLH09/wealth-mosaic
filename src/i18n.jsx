...
export const STRINGS = {
  en: {
    ...
    btnDone: "✓ Done",
    btnMore: "⋯ More",
    editingHint: "Edit mode — add or remove items, then press Done.",
    vaEyebrow: "Voice entry", vaTitle: "Voice assistant",
    vaHint: "Say “Dinner 500” to add, “Rent change to 20000” to edit, or “Delete rent” to remove.",
    vaPlaceholder: "e.g. Dinner 500 · Rent change to 20000 · Delete rent",
    vaTargetLabel: "Add to", vaTo: "to",
    vaAdd: "Add", vaModify: "Update", vaDelete: "Delete",
    vaConfirm: "Confirm", vaCancel: "Cancel", vaParse: "Parse",
    vaNotFound: (n) => `Couldn’t find “${n}”.`,
    vaNeedAmount: "Please include an amount too.",
    vaEmptyLog: "Your spoken changes will appear here.",
    vaTypeNote: "Voice isn’t supported for this language — type the command instead.",
    ...
    tabIntro: {
      ...
      invest: "Where your money is invested and how your goals are tracking.",
    ...
    retAdvanced: "Advanced settings", retAdvancedHint: "Return, inflation, withdrawal rate & balances",
  ...
  "zh-TW": {
    ...
    btnDone: "✓ 完成",
    btnMore: "⋯ 更多",
    editingHint: "編輯模式 — 可新增或刪除項目，完成後按「完成」。",
    vaEyebrow: "語音記帳", vaTitle: "語音助手",
    vaHint: "說「晚餐 500」新增、「房租 改成 20000」修改、「刪除 房租」刪除。",
    vaPlaceholder: "例如：晚餐 500 · 房租 改成 20000 · 刪除 房租",
    vaTargetLabel: "記到", vaTo: "到",
    vaAdd: "新增", vaModify: "修改", vaDelete: "刪除",
    vaConfirm: "確認", vaCancel: "取消", vaParse: "解析",
    vaNotFound: (n) => `找不到「${n}」。`,
    vaNeedAmount: "請順便說出金額。",
    vaEmptyLog: "你說出的變更會顯示在這裡。",
    vaTypeNote: "此語言尚未支援語音，請直接打字輸入指令。",
    ...
    tabIntro: {
      ...
      networth: "擁有的資產扣掉欠的負債，就是你的身價。",
      invest: "你的錢投資在哪、目標進度到哪。",
    ...
    retAdvanced: "進階設定", retAdvancedHint: "報酬率、通膨、提領率與現有資產",
  ...
  "zh-CN": {
    ...
    btnDone: "✓ 完成",
    btnMore: "⋯ 更多",
    editingHint: "编辑模式 — 可新增或删除项目，完成后按「完成」。",
    vaEyebrow: "语音记账", vaTitle: "语音助手",
    vaHint: "说「晚餐 500」新增、「房租 改成 20000」修改、「删除 房租」删除。",
    vaPlaceholder: "例如：晚餐 500 · 房租 改成 20000 · 删除 房租",
    vaTargetLabel: "记到", vaTo: "到",
    vaAdd: "新增", vaModify: "修改", vaDelete: "删除",
    vaConfirm: "确认", vaCancel: "取消", vaParse: "解析",
    vaNotFound: (n) => `找不到「${n}」。`,
    vaNeedAmount: "请顺便说出金额。",
    vaEmptyLog: "你说出的变更会显示在这里。",
    vaTypeNote: "此语言尚未支持语音，请直接打字输入指令。",
    ...
    tabIntro: {
      ...
      networth: "拥有的资产扣掉欠的负债，就是你的身价。",
      invest: "你的钱投资在哪、目标进度到哪。",
    ...
    retAdvanced: "进阶设定", retAdvancedHint: "报酬率、通胀、提领率与现有资产",
  ...
  ja: {
    ...
    btnDone: "✓ 完了",
    btnMore: "⋯ その他",
    editingHint: "編集モード — 項目を追加・削除して、終わったら「完了」を押してください。",
    ...
    tabIntro: {
      ...
      networth: "持っている資産から借金を引いたものが純資産です。",
      invest: "お金がどこに投資され、目標がどこまで進んでいるか。",
    ...
    retAdvanced: "詳細設定", retAdvancedHint: "利回り・インフレ・取崩率・現有資産",
  ...
  ko: {
    ...
    btnDone: "✓ 완료",
    btnMore: "⋯ 더보기",
    editingHint: "편집 모드 — 항목을 추가하거나 삭제한 뒤 완료를 누르세요.",
    ...
    tabIntro: {
      ...
      networth: "가진 자산에서 빚을 뺀 것이 순자산입니다.",
      invest: "돈이 어디에 투자되어 있고 목표가 얼마나 진행됐는지.",
    ...
    retAdvanced: "고급 설정", retAdvancedHint: "수익률·인플레이션·인출률·보유 자산",
