...
export const STRINGS = {
  en: {
    ...
    tabs: { cashflow: "Cash Flow", allocate: "Allocate", overview: "Wealth", invest: "Investments", retire: "Retirement" },
    tour: {
    ...
    tabIntro: {
      ...
      allocate: "Put your monthly surplus to work — assign a purpose to every dollar.",
      overview: "Your balance sheet, net worth, and savings goals in one place.",
    ...
    allocSub: "Split your monthly surplus — give every dollar a job",
    allocInvest: "Long-term investing",
    allocInvestSub: "Compounds over decades · auto-fills retirement",
    allocGoals: "Short-term goals",
    allocGoalsSub: "Builds your savings goals below",
    allocBuffer: "Keep as buffer",
    allocBufferSub: "Stays liquid — flexibility & safety",
    allocMonthly: (a) => `${a} / mo`,
    allocAutoNote: (a) => `Retirement contribution auto-set to ${a}/mo`,
    allocNoSurplus: "No surplus yet — fill in Cash Flow first.",
    secSinkingFunds: "Savings Goals",
    sfSub: "Named pots funded by your short-term goals slice",
    sfAdd: "+ Add a goal",
    sfTargetLabel: "Target", sfCurrentLabel: "Saved so far",
    sfMonthly: (a) => `+${a} / mo from allocation`,
    sfEta: (n) => n === null ? "—" : n <= 0 ? "Funded ✓" : `~${Math.ceil(n)} mo to go`,
    sfNoGoals: "No goals yet — add one below to track progress.",
    sfNoAlloc: "Set a goal allocation (%) above to see monthly progress.",
  ...
  "zh-TW": {
    ...
    tabs: { cashflow: "現金流", allocate: "分流", overview: "財富", invest: "投資", retire: "退休" },
    tour: {
    ...
    tabIntro: {
      ...
      allocate: "把每月盈餘賦予任務——決定每一塊錢要去哪裡。",
      overview: "資產負債表、淨值與儲蓄目標一頁掌握。",
      invest: "你的錢投資在哪。",
      retire: "試算存款大約能在何時支撐你不工作的生活。",
    },
    secAllocate: "盈餘分流",
    allocSub: "把每月盈餘切成三份，消除用途模糊的焦慮",
    allocInvest: "長期投資",
    allocInvestSub: "複利成長數十年 · 自動帶入退休試算",
    allocGoals: "短期目標",
    allocGoalsSub: "存入下方的儲蓄目標",
    allocBuffer: "保留緩衝",
    allocBufferSub: "保持流動性——彈性與安全感",
    allocMonthly: (a) => `${a} / 月`,
    allocAutoNote: (a) => `退休每月投入已自動設為 ${a}`,
    allocNoSurplus: "目前沒有盈餘——請先填寫現金流。",
    secSinkingFunds: "儲蓄目標",
    sfSub: "以短期目標比例為每個夢想建立專屬子帳戶",
    sfAdd: "+ 新增目標",
    sfTargetLabel: "目標金額", sfCurrentLabel: "已存金額",
    sfMonthly: (a) => `+${a} / 月（來自分流）`,
    sfEta: (n) => n === null ? "—" : n <= 0 ? "已達標 ✓" : `約 ${Math.ceil(n)} 個月達標`,
    sfNoGoals: "尚無目標——在下方新增一個來追蹤進度。",
    sfNoAlloc: "在上方設定短期目標比例（%），即可看到每月進度。",
