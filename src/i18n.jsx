...
export const STRINGS = {
  en: {
    ...
    investNote: "Note: keep these holdings in sync with the investment assets you list under Overview, so both views agree. This tool only tracks — investment decisions are your own or for a professional to advise on.",
  ...
  "zh-TW": {
    ...
    goalNoSurplus: "本月無結餘",
    investNote: "提醒:請讓這裡的持股與「總覽」資產負債表中列出的投資資產保持一致,兩邊數字才會吻合。投資相關決策請自行評估或諮詢專業人士,這個工具只負責追蹤。",
  ...
  "zh-CN": {
    ...
    goalNoSurplus: "本月无结余",
    investNote: "提醒:请让这里的持股与「总览」资产负债表中列出的投资资产保持一致,两边数字才会吻合。投资相关决策请自行评估或咨询专业人士,这个工具只负责追踪。",
    etaMonthYear: (d) => `${d.getFullYear()}年${d.getMonth() + 1}月`,
  ...
  ja: {
    ...
    investNote: "ご注意:ここの保有銘柄は「概要」のバランスシートに記載した投資資産と一致させ、両方の数字が揃うようにしてください。投資判断はご自身で、または専門家にご相談ください。このツールは記録のみを行います。",
    etaMonthYear: (d) => `${d.getFullYear()}年${d.getMonth() + 1}月`,
  ...
  ko: {
    ...
    investNote: "참고: 여기의 보유 종목을 「개요」 재무상태표에 입력한 투자 자산과 일치시켜 두 화면의 숫자가 맞도록 하세요. 투자 판단은 본인 또는 전문가와 상의하세요. 이 도구는 기록만 합니다.",
