      ...
      <div className="fd-wrap">
        ...
        <div className="fd-head">
          <div>
            ...
            <h1 className="fd-title">Wealth Mosaic</h1>
    ...
    <ResponsiveContainer width="100%" height={210}>
      <LineChart data={hist} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
        ...
        <Tooltip
          ...
          formatter={(v) => [money(v, cur), "Net worth"]} labelStyle={{ color: "#897c64" }} />
          ...
          <div className="card glow">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={m.series} margin={{ top: 8, right: 10, left: -2, bottom: 0 }}>
                <CartesianGrid stroke="rgba(42,32,19,.07)" vertical={false} />
                <XAxis dataKey="age" tickFormatter={(a) => a + "y"} tick={{ fill: "#897c64", fontSize: 11 }} axisLine={false} tickLine={false} />
                ...
                <Line type="monotone" name="Projected assets" dataKey="projected" stroke="#c2972f" strokeWidth={2.6} dot={false} />
                <Line type="monotone" name="Amount needed" dataKey="needed" stroke="#3c8a5f" strokeWidth={2} strokeDasharray="6 4" dot={false} />
              </LineChart>
            </ResponsiveContainer>
          </div>
